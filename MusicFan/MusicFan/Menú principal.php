...
<nav>
    ...
    <div class='Buttons2'>
        ...
        <button class='my-btn2' onclick= \"location.href = 'Acerca de nosotros.html'\">Acerca de nosotros</button>
    </div>
</nav>
<!-- Contenido -->
<content>
    ...
    <div class='container'>
        ...
        <div class='card'>
            ...
            <audio id='myAudio'>
                <source src='music/Space Junk - Wang Chung.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <audio id='myAudioD'>
            <source src='music/Dizzy - Joakim Karud.mp3' preload= 'none' type='audio/mpeg'>
        </audio>
    </div>
  ...
  <div class='card'>
        ...
        <audio id='myAudioG'>
            <source src='music/Go Shopping - Bran Van 3000 (320).mp3' preload= 'none' type='audio/mpeg'>
        </audio>
    </div>
    ...
    <div class='card'>
        ...
        <audio id='myAudioS'>
            <source src='music\Mtc - S3RL.mp3' preload= 'none' type='audio/mpeg'>
        </audio>
    </div>
    ...
    <div class='container'>
        ...
        <div class='card'>
            ...
            <audio id='myAudio2'>
                <source src='music/Come As You Are - Nirvana.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <div class='card'>
            ...
            <audio id='myAudio3'>
                <source src='music/Drain You - Nirvana.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <div class='card'>
            ...
            <audio id='myAudio4'>
                <source src='music/Something In The Way - Nirvana.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <div class='card'>
           ...
           Lithium</h3>
            ...
            <audio id='myAudio5'>
                <source src='music/Lithium - Nirvana.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
...
<br>
    ...
    <div class='container'>
        ...
        <div class='card'>
            ...
            <audio id='myAudioIn1'>
                <source src='music/Evil - Interpol.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <div class='card'>
            ...
            <audio id='myAudioIn2'>
                <source src='music/PDA (2012 Remaster).mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <div class='card'>
            ...
            <audio id='myAudioIn3'>
                <source src='music/Obstacle 1.mp3' preload= 'none' type='audio/mpeg'>
            </audio>
        </div>
        ...
        <audio id='myAudioIn4'>
            <source src='music/Narc - Interpol.mp3' preload= 'none' type='audio/mpeg'>
        </audio>
    </div>
